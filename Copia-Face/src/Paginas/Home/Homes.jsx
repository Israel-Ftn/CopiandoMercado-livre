  ...
  const slides = [
    {
      ...
      conteudo: <img className="rounded-t-2xl w-200" src={Carro1} alt="" />,
      valor: "R$ 350.000,00",
    ...
    },
    {
      ...
      conteudo: <img className="rounded-t-2xl w-200 " src={Carro2} />,
      valor: "R$ 250.000,00",
      Info: "Quero saber mais", 
    },
    {
      ...
      conteudo: <img className=" rounded-t-2xl w-200" src={Carro3} />,
